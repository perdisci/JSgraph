...
class Command(object):
    ...
    EnableTakeDOMTextSnapshot = "EnableTakeDOMTextSnapshot"
    DisableTakeDOMTextSnapshot = "DisableTakeDOMTextSnapshot"
    EnableAsynchronousParsing = "EnableAsynchronousParsing"
    DisableAsynchronousParsing = "DisableAsynchronousParsing"
    ...
    # valid commands list
    cmds = [Enable, Disable, EnableJavaScript, DisableJavaScript, EnableAsynchronousParsing, EnableTakeDOMTextSnapshot, DisableTakeDOMTextSnapshot, DisableAsynchronousParsing, StartRecording, StopRecording, DumpRecording, DumpReplayInfo, LoadRecording, StartReplay, StopReplay]
    ...
    __remote_methods = {
        Enable : "Forensics.enable",
        Disable : "Forensics.disable",
        EnableJavaScript : "Forensics.enableJavaScript",
        DisableJavaScript : "Forensics.disableJavaScript",
        EnableAsynchronousParsing : "Forensics.enableAsynchronousParsing",
        DisableAsynchronousParsing : "Forensics.disableAsynchronousParsing",
        EnableTakeDOMTextSnapshot : "Forensics.enableTakeDOMTextSnapshot",
        DisableTakeDOMTextSnapshot : "Forensics.disableTakeDOMTextSnapshot",
        StartRecording : "Forensics.startRecording",
